...
const Carousel = ({data,navId}) => {
    return (
        <div className='carousel-container'>
            ...
            virtual >
                {data.map(cardData => <SwiperSlide key={cardData.id}><Card imgSrc={cardData.image} followersCount={cardData.follows} label={cardData.title} numOfSongs={cardData.songs?cardData.songs.length:""} /></SwiperSlide>)}
            </Swiper>
